...
namespace forte::iec61131::booleanOperators {
  class CGenBoolBase : public CGenFunctionBlock<CFunctionBlock> {

    protected:
      CGenBoolBase(const StringId paInstanceNameId, CFBContainer &paContainer);
      ~CGenBoolBase() override = default;

      CIEC_BOOL &var_IN(size_t paIndex) {
    ...
    private:
      ...
      std::unique_ptr<CIEC_BOOL[]> mGenDIs;
