...
namespace forte::iec61131::booleanOperators {
  class GEN_XOR_BOOL : public CGenBoolBase {
      DECLARE_GENERIC_FIRMWARE_FB(GEN_XOR_BOOL)

    private:
      void executeEvent(TEventID paEIID, CEventChainExecutionThread *const paECET) override;

    public:
      GEN_XOR_BOOL(const StringId paInstanceNameId, CFBContainer &paContainer);
      ~GEN_XOR_BOOL() override = default;
  };
} // namespace forte::iec61131::booleanOperators
