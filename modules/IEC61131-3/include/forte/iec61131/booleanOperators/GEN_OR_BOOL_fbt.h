...
namespace forte::iec61131::booleanOperators {
  class GEN_OR_BOOL : public CGenBoolBase {
      DECLARE_GENERIC_FIRMWARE_FB(GEN_OR_BOOL)

    private:
      void executeEvent(TEventID paEIID, CEventChainExecutionThread *const paECET) override;

    public:
      GEN_OR_BOOL(const StringId paInstanceNameId, CFBContainer &paContainer);
      ~GEN_OR_BOOL() override = default;
  };
} // namespace forte::iec61131::booleanOperators
