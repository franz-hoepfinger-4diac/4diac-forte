...
namespace forte::iec61499::events::test {
  struct GEN_E_PERMIT_4_TestFixture : public forte::test::CFBTestFixtureBase {
      static constexpr TEventID EI1 = 0;
      static constexpr TEventID EI2 = 1;
      static constexpr TEventID EI3 = 2;
      static constexpr TEventID EI4 = 3;
      static constexpr TEventID EO1 = 0;
      static constexpr TEventID EO2 = 1;
      static constexpr TEventID EO3 = 2;
      static constexpr TEventID EO4 = 3;

      GEN_E_PERMIT_4_TestFixture() : CFBTestFixtureBase("iec61499::events::E_PERMIT_4"_STRID) {
        setInputData({&mInPERMIT});
        setup();
      }

      CIEC_BOOL mInPERMIT; // DATA INPUT, shared by all four channels
  };

  BOOST_FIXTURE_TEST_SUITE(GenEPermit4Tests, GEN_E_PERMIT_4_TestFixture)
  ...
  BOOST_AUTO_TEST_CASE(Permit) {
    ...
    triggerEvent(EI4);
    BOOST_CHECK(checkForSingleOutputEventOccurence(EO4));
  }
