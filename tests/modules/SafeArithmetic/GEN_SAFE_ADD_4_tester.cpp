...
namespace forte::SafeArithmetic::arithmetic {
  struct GEN_SAFE_ADD_4_TestFixture : public test::CFBTestFixtureBase {
      static constexpr TEventID REQ = 0;
      static constexpr TEventID CNF = 0;

      GEN_SAFE_ADD_4_TestFixture() : CFBTestFixtureBase("SafeArithmetic::arithmetic::SAFE_ADD_4"_STRID) {
  ...
  BOOST_FIXTURE_TEST_SUITE(GenSafeAdd4Tests, GEN_SAFE_ADD_4_TestFixture)
