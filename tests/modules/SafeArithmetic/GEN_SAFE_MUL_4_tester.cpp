...
namespace forte::SafeArithmetic::arithmetic {
  struct GEN_SAFE_MUL_4_TestFixture : public test::CFBTestFixtureBase {
      static constexpr TEventID REQ = 0;
      static constexpr TEventID CNF = 0;

      GEN_SAFE_MUL_4_TestFixture() : CFBTestFixtureBase("SafeArithmetic::arithmetic::SAFE_MUL_4"_STRID) {
  ...
  BOOST_FIXTURE_TEST_SUITE(GenSafeMul4Tests, GEN_SAFE_MUL_4_TestFixture)
